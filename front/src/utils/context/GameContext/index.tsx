...
export const GameProvider = ({ children }: { children: ReactNode }) => {
	...
	const [dataGame, setDataGameState] = useState<{mode?: string, isDouble?: boolean, speed?: number, id?: number}>(initialDataGame && status ? JSON.parse(initialDataGame) : {mode: undefined, isDouble: undefined, speed: undefined, id: undefined});
