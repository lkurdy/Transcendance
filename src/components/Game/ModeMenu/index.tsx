...
function ModeMenu()
{
	...
	const handleValidate = () => {
		...
		if (dataGame.mode === "online")
			setDataGame({...dataGame, mode: "training"});
	...
	return (<Container>
				...
				<MenuButton onClick={handleValidate} style={{ width: "55%", margin: "1.5vh", marginTop: "3vh", display: (!showMode && dataGame.isDouble !== undefined && dataGame.speed !== undefined) ? 'inline-block' : 'none' }}>Play {dataGame.mode} mode</MenuButton>
