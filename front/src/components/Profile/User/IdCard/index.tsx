	...
	return (<Container>
				<Public>
					<Primary>
						...
						{props.isLocal && <Edit onClick={handleEditPicture}>Edit</Edit>}
						{!editing && <Nickname>Hamid</Nickname>}
						{!editing && props.isLocal && <Edit onClick={handleEditNickname}>Edit</Edit>}
						...
						{<button onClick={handleEditStatus}>{status.isInvisible ? "Invisible" : status.activity}</button>}
